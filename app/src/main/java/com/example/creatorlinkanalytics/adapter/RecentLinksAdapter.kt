...
import com.example.creatorlinkanalytics.model.RecentLinks
...
class RecentLinksAdapter(
    ...
    private val items: ArrayList<RecentLinks> = arrayListOf()

    fun setData(itemsData: ArrayList<RecentLinks>) {
        items.clear()
